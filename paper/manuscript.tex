...
\item
  ...
  Ω\_add,₀₂₅ \textgreater{} 0 on \textbf{9.3\% (7.29--11.32\%)} against a nominal 2.5\% (§4.3).
\item
...
\section{4.4 The operating characteristic, and what recovery costs}\label{the-operating-characteristic-and-what-recovery-costs}
...
The conventional Ω\_add,₀₂₅ \textgreater{} 0 cut reaches the same 12 at 9.3\% (§4.3); the
...
Ω₀₂₅ of \textbf{+1.82} is remarkable in context: §4.3 shows the multiplicative null
